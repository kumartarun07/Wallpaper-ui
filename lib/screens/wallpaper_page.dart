            ...
            return ListView(
              ...
              children: [
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => BlocProvider(
                                          ...
                                          child: SearchWallPage(
                                              query: wallController.text))));
                            } else {
                              ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                      content: Text(
                                          "Error: Please fill blank field")));
                            }
                          },
                          icon: Icon(
                            Icons.search,
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        DetailPage(srcModel: eachPhoto.src!)));
                          },
                          child: Container(
                              height: 200,
                              width: 150,
                              margin: EdgeInsets.only(
                                  left: 16,
                                  right: index == Portrait.wall.length - 1
                                      ? 16
                                      : 0),
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(
                                        eachPhoto.src!.portrait.toString()),
                                    fit: BoxFit.cover),
                ...
                Container(
                    ...
                    width: double.infinity,
                    child: ListView.builder(
                        itemCount: ColorPage.kamal.length,
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (_, index) {
                          return InkWell(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => BlocProvider(
                                          ...
                                          child: SearchWallPage(
                                              query:
                                                  wallController.text.isNotEmpty
                                                      ? wallController.text
                                                      : "Nature",
                                              color: ColorPage.kamal[index]
                                                  ['Code']))));
                            },
                            child: Container(
                              height: 50,
                              ...
                              margin: EdgeInsets.only(
                                  left: 16,
                                  right: index == ColorPage.kamal.length - 1
                                      ? 16
                                      : 0),
                              decoration: BoxDecoration(
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage(
                                      LandScape.pic[index]["WallPaper"]),
                                  fit: BoxFit.cover)),
                          child: Center(
                            child: Text(
                              LandScape.pic[index]['title'],
                              style: mTextStyle16(
                                  mColor: Colors.white,
